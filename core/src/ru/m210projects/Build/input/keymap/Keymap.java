...
public class Keymap {
    ...
    public static final int MOUSE_WHELLUP = 0xE0; // 224
    ...
    public static final int MOUSE_BUTTON11 = 0xEC; // 236

    // Gamepad buttons
    public static final int BUTTON_UP = 0xED; // 237
    public static final int BUTTON_RIGHT = 0xEE; // 238
    public static final int BUTTON_DOWN = 0xEF; // 239
    public static final int BUTTON_LEFT = 0xF0; // 240
    ...
    public static int valueOf(String keyname) {
        ...
        return keyNames.getOrDefault(keyname, UNKNOWN);
    }

    private static void initializeKeyNames() {
        keyNames = new HashMap<>();
        for (int i = 0; i < 256; i++) {
            keyNames.put(toString(i), i);
        }
    }
}
