...
public class WallFrustum2d implements Poolable {
    ...
    public WallFrustum2d set(BuildCamera camera, int sectnum) {
    ...
    public WallFrustum2d set(BuildCamera camera, Wall wal) {
        ...
        float x2 = wal2.getX() - x;
        float y2 = wal2.getY() - y;
...
//		planes[num].d = -(globalposx * n.x + globalposy * n.y + globalposz * n.z);
    ...
    public boolean wallInFrustum(Wall wal) {
        ...
        int x1 = (int) (wal.getX() - x);
        int y1 = (int) (wal.getY() - y);
        Wall wal2 = wal.getWall2();
        int x2 = (int) (wal2.getX() - x);
        int y2 = (int) (wal2.getY() - y);
    ...
    private boolean NearPlaneCheck(Wall wal) {
        ...
        int x2 = (int) (wal.getWall2().getX() - x);
        int y2 = (int) (wal.getWall2().getY() - y);
