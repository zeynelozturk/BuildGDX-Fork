...
//Copyright (C) 2020  Raif S. Naffah, Ronald L. Rivest, Alexander Makarov-[M210] (m210-2007@mail.ru)
//
 ...
 */
public class MD4 {
	private final static MD4Digest MD4 = new MD4Digest();

	private static class MD4Digest extends MessageDigest {
		...
		/**
		 * Resets this object disregarding any temporary data present at the time of the
		 ...
		 * context and count, and leaving (buffering) the remaining bytes in buffer for
		 * the next update or finish.
		 *
